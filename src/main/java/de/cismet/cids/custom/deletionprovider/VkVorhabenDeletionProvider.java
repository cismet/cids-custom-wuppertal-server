...
public class VkVorhabenDeletionProvider extends AbstractCustomDeletionProvider {

    //~ Static fields/initializers ---------------------------------------------

    private static final Logger LOG = Logger.getLogger(VkVorhabenDeletionProvider.class);
    public static final String TABLE_NAME = "vk_vorhaben";
    private static final String DELETE_TEXT = "Dieses Vorhaben kann nicht gelöscht werden.";
