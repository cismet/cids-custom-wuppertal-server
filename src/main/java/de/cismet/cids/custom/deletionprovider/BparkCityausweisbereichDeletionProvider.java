...
public class BparkCityausweisbereichDeletionProvider extends AbstractCustomDeletionProvider {

    //~ Static fields/initializers ---------------------------------------------

    private static final Logger LOG = Logger.getLogger(BparkCityausweisbereichDeletionProvider.class);
    ...
    public boolean isMatching(final User user, final MetaObject metaObject) {
        ...
        final String queryZoneInFlaeche = String.format(
