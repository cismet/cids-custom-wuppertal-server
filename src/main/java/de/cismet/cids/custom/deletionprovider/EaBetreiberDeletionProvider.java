...
public class EaBetreiberDeletionProvider extends AbstractCustomDeletionProvider {

    //~ Static fields/initializers ---------------------------------------------

    private static final Logger LOG = Logger.getLogger(EaBetreiberDeletionProvider.class);
    private static final String TABLE_NAME = "ea_betreiber";
    private static final String FIELD__ID = "id";
    private static final String FIELD__FK = "fk_betreiber";
    private static final String TABLE_NAME_SEARCH = "ea_standort";
    private static final String CAUSE =
        "Dieser Betreiber kann nicht gelöscht werden, da dieser bei mindestens einem Standort verwendet wird.";

    //~ Instance fields --------------------------------------------------------

    private String deleteText = "Dieser Betreiber kann nicht gelöscht werden, da dieser verwendet wird.";
    ...
    public boolean isMatching(final User user, final MetaObject metaObject) {
        ...
        try {
            ...
            LOG.error("Cannot delete Betreiber object", ex);
        }
        return false;
    }
