...
public class BaumWurzelDeletionProvider extends AbstractCustomDeletionProvider {

    //~ Static fields/initializers ---------------------------------------------

    private static final Logger LOG = Logger.getLogger(BaumWurzelDeletionProvider.class);
    private static final String TABLE_NAME = "baum_wurzel";
    private static final String FIELD__ID = "id";
    private static final String FIELD__FK = "fk_wurzel";
    private static final String TABLE_NAME_SEARCH_S = "baum_schaden_wurzel";
