...
public class BaumMassnahmeDeletionProvider extends AbstractCustomDeletionProvider {

    //~ Static fields/initializers ---------------------------------------------

    private static final Logger LOG = Logger.getLogger(BaumMassnahmeDeletionProvider.class);
    private static final String TABLE_NAME = "baum_massnahme";
    private static final String FIELD__ID = "id";
    private static final String FIELD__FK = "fk_massnahme";
    private static final String TABLE_NAME_SEARCH_S = "baum_schaden_massnahme";
    private static final String DELETE_TEXT = "Diese Maßnahme kann nicht gelöscht werden, da diese verwendet wird.";
