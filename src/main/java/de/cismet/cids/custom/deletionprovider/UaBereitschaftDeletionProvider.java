...
public class UaBereitschaftDeletionProvider extends AbstractCustomDeletionProvider {
    ...
    public boolean isMatching(final User user, final MetaObject metaObject) {
        ...
        final CidsBean bereitBean = metaObject.getBean();
        final Integer bereit_id = bereitBean.getPrimaryKeyValue();

        final String queryBereitIn = String.format(
